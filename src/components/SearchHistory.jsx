  ...
  return (
    <div className="mt-6">
      ...
      <div className="space-y-2 flex flex-col">
        {history.map((city) => (
          <button key={city} type="button" onClick={() => onCityClick(city)} className="flex items-center justify-between w-full px-3 py-2 bg-white rounded hover:bg-gray-200 cursor-pointer">
